...
namespace GataryLabs.DependencyInjection
{
    internal class Injector
    {
        internal void CheckInjection(object instance, Type type, InjectableScope injectableScope)
        {
            ...
            {
                if (injectionTargetAttribute.Flags.HasFlag(InjectionFlags.Fields))
                {
                ...
                if (injectionTargetAttribute.Flags.HasFlag(InjectionFlags.Properties))
                {
                ...
                if (injectionTargetAttribute.Flags.HasFlag(InjectionFlags.Methods))
                {
        ...
        internal Type[] FindInjectableConstructorParameters(Type type)
        {
            ...
            if (injectionTargetAttribute != null && injectionTargetAttribute.Flags.HasFlag(InjectionFlags.Constructors))
            {
